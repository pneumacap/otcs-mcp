...
// ── Core imports ──
import { OTCSClient } from '../packages/core/src/client/otcs-client';
import { toMCPTools } from '../packages/core/src/tools/formats';
import { handleToolCall } from '../packages/core/src/tools/handler';
import { getSuggestion } from '../packages/core/src/tools/utils';
...
const config = {
  ...
  tlsSkipVerify: process.env.OTCS_TLS_SKIP_VERIFY === 'true',
};
...
const TOOL_PROFILES: Record<string, string[]> = {
  core: [
    ...
    'otcs_upload_folder',
    'otcs_upload_batch',
    'otcs_upload_with_metadata',
    'otcs_download_content',
    'otcs_versions',
    'otcs_search_workspaces',
    'otcs_get_workspace',
  ...
  workflow: [
    ...
    'otcs_search_workspaces',
    'otcs_get_workspace',
    'otcs_workspace_types',
    'otcs_get_assignments',
    'otcs_workflow_status',
    'otcs_workflow_definition',
    'otcs_workflow_tasks',
    'otcs_workflow_activities',
    'otcs_workflow_form',
    'otcs_workflow_task',
    'otcs_start_workflow',
    'otcs_draft_workflow',
    'otcs_workflow_info',
    'otcs_manage_workflow',
    'otcs_members',
    'otcs_permissions',
    'otcs_categories',
  ],
  admin: [
    ...
    'otcs_search_workspaces',
    'otcs_get_workspace',
    'otcs_create_workspace',
    'otcs_create_workspaces',
    'otcs_workspace_types',
    'otcs_workspace_relations',
    'otcs_workspace_roles',
    'otcs_get_assignments',
    'otcs_workflow_form',
    'otcs_workflow_task',
    'otcs_members',
    'otcs_group_membership',
    'otcs_permissions',
    'otcs_categories',
    'otcs_workspace_metadata',
    'otcs_rm_classification',
    'otcs_rm_holds',
    'otcs_rm_xref',
    'otcs_rm_rsi',
    'otcs_share',
...
const server = new Server({ name: 'otcs-mcp', version: '1.0.0' }, { capabilities: { tools: {} } });
...
async function handleAuthTool(name: string, args: Record<string, unknown>): Promise<unknown> {
  switch (name) {
