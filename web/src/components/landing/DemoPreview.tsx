    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <p className="text-[13.5px] text-gray-700 dark:text-gray-300">
          Found <strong className="font-semibold text-gray-900 dark:text-white">3 contracts</strong>{' '}
          expiring in Q1 2026:
        </p>
  ...
  const lines = [
    {
      label: 'Enterprise',
      color: '#4285F4',
      values: [82, 88, 95, 92, 98, 100, 103, 108, 112, 118, 125, 135],
    },
    {
      label: 'Professional',
      color: '#34A853',
      values: [35, 40, 45, 48, 52, 55, 58, 62, 65, 68, 72, 78],
    },
    {
      label: 'Services',
      color: '#EA4335',
      values: [28, 30, 32, 35, 38, 40, 42, 48, 50, 52, 55, 50],
    },
      ...
      <div className="space-y-3">
        <p className="text-[13.5px] text-gray-700 dark:text-gray-300">
          <strong className="font-semibold text-gray-900 dark:text-white">
            2025 SaaS Performance Dashboard:
          </strong>
        </p>
        ...
        <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
          <table className="w-full text-left text-[12.5px]">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Total Revenue</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">$2,876,800</td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Total Profit</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">
                  $1,475,200 (51.3% margin)
                </td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Top Revenue Line</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">
                  Enterprise ($1.25M, 44% share)
                </td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Fastest Growing</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">
                  Starter (268% growth Jan→Dec)
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div className="space-y-3">
        ...
        <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
          <table className="w-full text-left text-[12.5px]">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Review Document</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">Medium</td>
                ...
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">178339</td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Review Document</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">Medium</td>
                ...
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">177804</td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Pending Approval</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">High</td>
                <td className="px-3 py-2">
                ...
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">179479</td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Review Document</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">Medium</td>
                ...
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">179669</td>
              </tr>
            </tbody>
          </table>
        </div>
        <p className="text-[12.5px] text-gray-600 dark:text-gray-400">
          You have 3 &quot;Review Document&quot; and 1 &quot;Pending Approval&quot; tasks. Would you
          like details on any of these?
        </p>
      </div>
      <FauxInput />
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <p className="text-[13.5px] text-gray-700 dark:text-gray-300">
          ...
          <strong className="font-semibold text-gray-900 dark:text-white">LN Deed - 500301</strong>{' '}
          (scanned TIFF, 3 MB):
        </p>
        <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
          <table className="w-full text-left text-[12.5px]">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Document Type</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">Deed of Trust</td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Grantor</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">
                  George & Martha Washington
                </td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Lien Amount</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">$150,000.00</td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Property</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">
                  1789 Plantation Rd, Mount Vernon, VA
                </td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-gray-900 dark:text-gray-100">Trustee</td>
                <td className="px-3 py-2 text-gray-600 dark:text-gray-400">
        ...
        <p className="text-[12.5px] text-gray-600 dark:text-gray-400">
          This is a standard deed of trust securing a $150,000 loan against the residential
          property. The document contains 13 pages covering conveyance, environmental compliance,
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-800 dark:bg-gray-900">
          ...
          <div className="flex items-center gap-2 border-b border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-800 dark:bg-gray-800/50">
            ...
            <span className="text-sm font-medium text-gray-900 dark:text-white">Altius</span>
          ...
          {/* Active slide */}
          <div className="p-6">{slides[active].component}</div>
        </div>
      </div>
    </section>
  );
